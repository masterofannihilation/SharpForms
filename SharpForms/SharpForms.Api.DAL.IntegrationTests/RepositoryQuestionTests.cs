...
namespace SharpForms.Api.DAL.IntegrationTests
{
    public class RepositoryQuestionTests
    {
        ...
        {
            var question = new QuestionEntity { Id = Guid.NewGuid(), Text = "Sample question", Order = 1, AnswerType = AnswerType.Text };
        ...
        public void Get_Question_By_Id_Check_Included_Entities()
        {
            ...
            var Answer = _storage.Answers.SingleOrDefault(o => o.Id == new Guid("b4505f75-f177-4076-832d-8fd1677c9a18")); // Seed data
            var Form = _storage.Forms.SingleOrDefault(o => o.Id == new Guid("01e7e4c9-1ad7-4688-883e-69b6591338b8")); // Seed data
